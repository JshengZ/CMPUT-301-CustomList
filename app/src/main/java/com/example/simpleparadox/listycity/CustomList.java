...
//        return super.getView(position, convertView, parent);
     ...
     * @return
     *      Return an integer which indicates the city number
     */
    public int getCount(){
        return cities.size();
    }
    ...
    /**
     * This function will add a city object into a list
     * @param city
     */
    ...
    /**
     * This count the number of the city objects
     * @return
     *      Return an integer which indicates the number of the city objects.
     */
